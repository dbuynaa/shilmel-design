          ...
          <div className="container mx-auto px-4 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-sm text-gray-600">Даваа - Баасан, 9:00 - 18:00</p>
              </div>
              <div>
                <h3 className="font-semibold mb-4">Компани</h3>
              ...
              <div>
                <h3 className="font-semibold mb-4">Үйлчилгээ</h3>
                <ul className="space-y-2">
                  <li>
                    <Link href="/shipping" className="text-sm text-gray-600 hover:text-pink-600">
                      Тээвэр
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                <h3 className="font-semibold mb-4">Сошиал</h3>
